...
protocol EditCategoryDetailViewProtocol: AnyObject { // O protocol tipo Class foi substituido pelo tipo AnyObject
    func actionSaveButton()
    func actionCancelButton()
}

class EditCategoryDetailView: UIView {
        
        private var delegate: EditCategoryDetailViewProtocol?
        
        func delegate(delegate: EditCategoryDetailViewProtocol?){
